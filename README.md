...
(3) create index
    curl -XPUT http://192.168.1.207:9200/knowledgebase
(4) execute the create_index.sh script
    bash create_index.sh
(5) execute the new_post2es.py in the data.json directory using python2.7
